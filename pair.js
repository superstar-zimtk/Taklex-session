            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'TAKLEX-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
                    ...
                    const MALVIN_TEXT = `
🎉 *Welcome to TAKLEX-MD!* 🚀  

🔒 *Your Session ID* is ready!  ⚠️ _Keep it private and secure — dont share it with anyone._ 

🔑 *Copy & Paste the SESSION_ID Above*🛠️ Add it to your environment variable or contact zimtk4 263715305976: *SESSION_ID*.  

💡 *Whats Next?* 
1️⃣ Explore all the cool features of TAKLEX-MD.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation by zimtk! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb9qprVJuyAJxcTO252t) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [*Super star zimtk GitHub Repo*](https://github.com/superstar-zimtk/)  

🚀 _Thanks for choosing TAKLEX-MD — Let the automation begin!_ ✨`;
